export const MockInterviewData = [
    {
        id: 1,
        name: "Anna Huỳnh",
        image: "/MockInterview/AnnaHuynh.png",
        career: "HR executive",
        pricing: 200000,
        badges: ["3 - 5 năm", "Recruitment", "Analytics", "Digital Marketing", "Content Creation", "Creativity"],
        period: ["8:00AM", "12:00PM", "4:00PM"],
        about: `Tôi là Anna Huỳnh, đảm nhận vị trí HR Executive tại Công ty TNHH Daiko với 5 năm kinh nghiệm. 
                Tôi đã đồng hành cùng nhiều ứng viên, đặc biệt là các bạn trẻ có đam mê với lĩnh vực Digital Marketing và Content Creation. 
                Với kinh nghiệm chuyên môn trong việc đánh giá kỹ năng mềm và phân tích hành vi ứng viên, <b>tôi có thể giúp bạn:</b>
                <ul>
                    <li><strong>Nắm vững kỹ năng phỏng vấn:</strong> Thông qua các buổi phỏng vấn giả định thực tế, tôi sẽ cung cấp những đánh giá chi tiết, giúp bạn tự tin hơn khi đối diện với nhà tuyển dụng.</li>
                    <li><strong>Xây dựng thương hiệu cá nhân:</strong> Tôi sẽ hỗ trợ bạn khám phá thế mạnh và lựa chọn con đường sự nghiệp phù hợp.</li>
                    <li><strong>Chuẩn bị hồ sơ xin việc ấn tượng:</strong> Tôi sẽ giúp bạn nâng cấp CV và luyện tập kỹ năng viết thư xin việc hiệu quả.</li>
                </ul>`,
        reviews: [
            { id: 1, name: "Phạm Quỳnh Anh", comment: "Buổi phỏng vấn mô phỏng quá thực tế! Nhờ những góp ý chi tiết của mentor, em đã tự tin hơn rất nhiều cho buổi phỏng vấn thực tế sắp tới.", rating: 5, date: "1 ngày trước" },
            { id: 2, name: "Nguyễn Anh Tú", comment: "Mentor đã giúp em nhận ra những điểm cần cải thiện trong cách trả lời phỏng vấn. Nhờ đó, em đã có một buổi phỏng vấn thành công.", rating: 5, date: "1 ngày trước" },
            { id: 3, name: "Nguyễn Anh Tài", comment: "", rating: 4, date: "2 ngày trước" },
            { id: 4, name: "Nguyễn Ngọc", comment: "", rating: 4, date: "2 ngày trước" },
        ]
    },
    {
        id: 2,
        name: "Lương Hữu Khánh",
        image: "/MockInterview/LuongHuuKhanh.png",
        career: "HR executive",
        pricing: 250000,
        badges: ["1 - 3 năm", "Brand Management", "Strategic Planning", "Public Relations", "Leadership", "Project Management"],
        period: ["8:00AM", "12:00PM", "3:00PM", "7:00PM"],
        about: `Tôi là Lương Hữu Khánh - một chuyên gia nhiều kinh nghiệm trong lĩnh vực Nhân sự (HR), với hơn 10 năm làm việc tại các tập đoàn lớn. 
                Không chỉ am hiểu sâu về các quy trình tuyển dụng, mà còn nổi bật với khả năng sáng tạo, phân tích dữ liệu và tiếp thị số (Digital Marketing). 
                Với nền tảng vững chắc trong việc tạo nội dung (Content Creation) và quản lý nhân sự, tôi đã giúp nhiều công ty xây dựng đội ngũ nhân sự hiệu quả và triển khai những chiến dịch marketing thành công. 
                <strong>Tôi có thể giúp bạn:</strong>
                <ul>
                    <li><strong>Kỹ năng phỏng vấn và tuyển dụng:</strong> Cách thể hiện tốt nhất trong các buổi phỏng vấn tuyển dụng, từ việc chuẩn bị hồ sơ, đối đáp câu hỏi cho đến cách gây ấn tượng mạnh với nhà tuyển dụng.</li>
                    <li><strong>Phát triển tư duy sáng tạo và quản lý nội dung:</strong> Tối ưu hóa khả năng sáng tạo của mình, từ việc phát triển nội dung tiếp thị đến xây dựng chiến lược digital marketing phù hợp.</li>
                    <li><strong>Phân tích và ra quyết định dựa trên dữ liệu:</strong> Sử dụng dữ liệu để đưa ra các quyết định quản lý hiệu quả, đặc biệt trong lĩnh vực nhân sự và marketing.</li>
                </ul>`,
        reviews: [
            { id: "1", name: "Lê Thị Lựu", comment: "", rating: 5, date: "1 ngày trước" },
            { id: "2", name: "Nguyễn A", comment: "", rating: 5, date: "1 ngày trước" },
            { id: "3", name: "Đặng B", comment: "", rating: 4, date: "2 ngày trước" },
            { id: "4", name: "Kim C", comment: "", rating: 4, date: "2 ngày trước" },
            { id: "5", name: "Nguyễn Anh Tú", comment: "Em rất ấn tượng với sự chuyên nghiệp và kinh nghiệm của mentor. Buổi phỏng vấn mô phỏng đã giúp em học hỏi được rất nhiều điều.", rating: 5, date: "2 ngày trước" },
        ]
    },
    {
        id: 3,
        name: "Trần Văn Bảo",
        image: "/MockInterview/TranVanBao.jpg",
        ...
        period: ["10:00AM", "2:00PM", "5:00PM"],
        about: `
            Tôi là Trần Văn Bảo, một chuyên gia Marketing với hơn 7 năm kinh nghiệm trong ngành. 
            Tôi đã làm việc cho nhiều thương hiệu lớn và giúp họ xây dựng chiến lược tiếp thị thành công.
            Tôi am hiểu về Digital Marketing, từ SEO, quảng cáo trả tiền đến quản lý nội dung. 
            <strong>Tôi có thể giúp bạn:</strong>
            <ul>
                <li><strong>Phát triển chiến lược marketing hiệu quả:</strong> Hỗ trợ bạn trong việc xây dựng các chiến dịch marketing tích hợp.</li>
                <li><strong>Chạy quảng cáo trực tuyến thành công:</strong> Hướng dẫn bạn cách tối ưu hóa các chiến dịch quảng cáo trên các nền tảng khác nhau.</li>
                <li><strong>Tối ưu hóa nội dung và SEO:</strong> Cung cấp những mẹo để cải thiện vị trí của bạn trên các công cụ tìm kiếm.</li>
            </ul>`,
        reviews: [
            { id: 1, name: "Nguyễn Văn Dũng", comment: "Mentor rất nhiệt tình và có kiến thức chuyên sâu về Digital Marketing.", rating: 5, date: "3 ngày trước" },
            { id: 2, name: "Lê Minh Tâm", comment: "Tôi đã học được rất nhiều từ buổi tư vấn. Chắc chắn sẽ quay lại.", rating: 5, date: "5 ngày trước" },
            { id: 3, name: "Phạm Thị Lan", comment: "Buổi học thật sự bổ ích, cảm ơn anh Bảo rất nhiều!", rating: 4, date: "1 tuần trước" },
            { id: 4, name: "Trần Vân", comment: "Chưa bao giờ có buổi tư vấn nào lại chi tiết và dễ hiểu như thế này.", rating: 5, date: "1 tuần trước" },
